...
export declare const DELETE_CALL_HISTORY_RECORDS_ENDPOINT = "markAsDeleted";
...
export declare const SET_DELETE_CALL_RECORDS_SUCCESS_MESSAGE = "Call history records are deleted by the user.";
export declare const SET_DELETE_CALL_RECORDS_INVALID_DATE_FORMAT_MESSAGE = "The provided date is malformed or invalid";
