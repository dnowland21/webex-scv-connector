...
export declare const SCIM_USER_FILTER = "v2/Users?filter=";
...
export declare const UNPROCESSABLE_CONTENT_CODE = 422;
...
export declare const BW_XSI_ENDPOINT_VERSION_WITH_SLASH = "v2.0/";
...
export declare const SCIM_WEBEXIDENTITY_USER = "urn:scim:schemas:extension:cisco:webexidentity:2.0:User";
