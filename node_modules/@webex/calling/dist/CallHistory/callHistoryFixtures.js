...
exports.sortedCallHistory = exports.mockCallHistoryBody = exports.janusSetReadStateUrl = exports.janusMarkAsDeletedUrl = exports.MOCK_UPDATE_MISSED_CALL_RESPONSE = exports.MOCK_SESSION_EVENT_VIEWED = exports.MOCK_SESSION_EVENT_LEGACY = exports.MOCK_SESSION_EVENT_DELETED = exports.MOCK_SESSION_EVENT = exports.MOCK_LINES_API_CALL_RESPONSE_WITH_NO_LINEDATA = exports.MOCK_LINES_API_CALL_RESPONSE = exports.MOCK_DELETE_CALL_HISTORY_RECORDS_RESPONSE = exports.MOCK_DELETE_CALL_HISTORY_INVALID_DATE_RESPONSE = exports.MOCK_CALL_HISTORY_WITH_UCM_LINE_NUMBER = exports.MOCK_CALL_HISTORY_WITHOUT_UCM_LINE_NUMBER = exports.ERROR_DETAILS_401 = exports.ERROR_DETAILS_400 = void 0;
var _types = require("../Events/types");
var sortedCallHistory = exports.sortedCallHistory = {
  body: {
    statusCode: 200,
    userSessions: [{
...
var mockCallHistoryBody = exports.mockCallHistoryBody = {
  body: {
    statusCode: 200,
    userSessions: [{
      id: 'd74d19cc-6aa7-f341-6012-aec433cc6f8d',
 ...
 */
var MOCK_CALL_HISTORY_WITH_UCM_LINE_NUMBER = exports.MOCK_CALL_HISTORY_WITH_UCM_LINE_NUMBER = {
  body: {
    statusCode: 200,
    userSessions: [{
      id: '123456',
 ...
 */
var MOCK_CALL_HISTORY_WITHOUT_UCM_LINE_NUMBER = exports.MOCK_CALL_HISTORY_WITHOUT_UCM_LINE_NUMBER = {
  body: {
    statusCode: 200,
    userSessions: [{
      id: '123456',
...
var WEBEX_CALL_SESSION = {
  ...
  url: 'https://janus-a.wbx2.com/janus/api/v1/history/userSessions/d74d19cc-6aa7-f341-6012-aec433cc6f8d',
  sessionId: 'd74d19cc-6aa7-f341-6012-aec433cc6f8d',
  sessionType: _types.SessionType.WEBEX_CALLING,
  startTime: '2022-08-02T10:45:21.565Z',
  endTime: '2022-08-02T10:53:01.624Z',
  direction: 'OUTGOING',
  disposition: _types.Disposition.INITIATED,
  other: {
    id: 'c9bde63c-e3e2-4db4-ba45-0d6c698ffd65',
    name: 'test',
    isPrivate: false,
...
var SPARK_CALL_SESSION = {
  ...
  sessionType: _types.SessionType.SPARK,
...
var MOCK_SESSION_EVENT = exports.MOCK_SESSION_EVENT = {
  ...
  data: {
    ...
    eventType: _types.MOBIUS_EVENT_KEYS.CALL_SESSION_EVENT_INCLUSIVE
  },
  timestamp: 12345,
  trackingId: 'tracking-id'
};
var MOCK_SESSION_EVENT_LEGACY = exports.MOCK_SESSION_EVENT_LEGACY = {
  id: 'id',
  data: {
    userSessions: {
    ...
    eventType: _types.MOBIUS_EVENT_KEYS.CALL_SESSION_EVENT_LEGACY
  },
  timestamp: 12345,
  trackingId: 'tracking-id'
};
...
var MOCK_SESSION_EVENT_DELETED = exports.MOCK_SESSION_EVENT_DELETED = {
  id: 'id',
  data: {
    deletedSessions: ['123-456-789-99999-993939'],
    eventType: _types.MOBIUS_EVENT_KEYS.CALL_SESSION_EVENT_DELETED
  },
  timestamp: 12345,
  trackingId: 'tracking-id'
};
...
var MOCK_DELETE_CALL_HISTORY_RECORDS_RESPONSE = exports.MOCK_DELETE_CALL_HISTORY_RECORDS_RESPONSE = {
  statusCode: 200,
  data: {
...
var MOCK_DELETE_CALL_HISTORY_INVALID_DATE_RESPONSE = exports.MOCK_DELETE_CALL_HISTORY_INVALID_DATE_RESPONSE = {
  statusCode: 400,
  data: {
...
var janusMarkAsDeletedUrl = exports.janusMarkAsDeletedUrl = 'https://janus-intb.ciscospark.com/janus/api/v1/history/userSessions/markAsDeleted';
 ...
 */
var MOCK_LINES_API_CALL_RESPONSE = exports.MOCK_LINES_API_CALL_RESPONSE = {
  statusCode: 200,
  data: {
    lines: {
      devices: [{
 ...
 */
var MOCK_LINES_API_CALL_RESPONSE_WITH_NO_LINEDATA = exports.MOCK_LINES_API_CALL_RESPONSE_WITH_NO_LINEDATA = {
  statusCode: 200,
  data: {},
  message: 'SUCCESS'
};
