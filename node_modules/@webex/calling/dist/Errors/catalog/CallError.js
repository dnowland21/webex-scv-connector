...
exports.createCallError = exports.CallError = void 0;
...
var CallError = exports.CallError = /*#__PURE__*/function (_ExtendedError) {
   ...
   */
  function CallError(msg, context, type, correlationId, errorLayer) {
    var _this;
    (0, _classCallCheck2.default)(this, CallError);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "errorLayer", void 0);
    _this.correlationId = correlationId;
    _this.errorLayer = errorLayer;
    return _this;
  }
   ...
   */
  (0, _createClass2.default)(CallError, [{
    key: "setCallError",
    value: function setCallError(error) {
