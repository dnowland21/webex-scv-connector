...
declare function retainCodecs(av: AvMediaDescription, predicate: (codecInfo: CodecInfo) => boolean): boolean;
declare function retainCodecsByCodecName(av: AvMediaDescription, allowedCodecNames: Array<string>): boolean;
declare function retainCandidates(sdpOrMedia: Sdp | MediaDescription, predicate: (candidate: CandidateLine) => boolean): boolean;
declare function retainCandidatesByTransportType(sdpOrMedia: Sdp | MediaDescription, allowedTransportTypes: Array<string>): boolean;
