...
declare enum PeerConnectionEvents {
...
interface PeerConnectionEventHandlers extends EventMap {
    ...
    [PeerConnectionEvents.SetLocalDescriptionOnSuccess]: (description: RTCSessionDescription | RTCSessionDescriptionInit) => void;
    [PeerConnectionEvents.SetRemoteDescriptionOnSuccess]: (description: RTCSessionDescription | RTCSessionDescriptionInit) => void;
}
type ConnectionType = 'UDP' | 'TCP' | 'TURN-TLS' | 'TURN-TCP' | 'TURN-UDP' | 'unknown';
/**
 * Manages a single RTCPeerConnection with the server.
 */
declare class PeerConnection extends EventEmitter<PeerConnectionEventHandlers> {
    static Events: typeof PeerConnectionEvents;
    private pc;
     ...
     */
    addTransceiver(trackOrKind: MediaStreamTrack | MediaStreamTrackKind, init?: RTCRtpTransceiverInit): RTCRtpTransceiver;
    /**
