...
})(exports.BlurStrength || (exports.BlurStrength = {}));
const getBlurConfig = (blur_strength, horizontal_mirror) => {
    let kernel_size = 25;
    let sigma = 11;
    switch (blur_strength) {
        case exports.BlurStrength.WEAK:
            kernel_size = 9;
            sigma = 2;
            break;
        case exports.BlurStrength.MODERATE:
            kernel_size = 15;
            sigma = 6;
            break;
        case exports.BlurStrength.STRONG:
            kernel_size = 25;
            sigma = 11;
            break;
        case exports.BlurStrength.STRONGER:
            kernel_size = 37;
            sigma = 17;
            break;
        case exports.BlurStrength.STRONGEST:
            kernel_size = 49;
            sigma = 23;
            break;
    }
...
const getPreloadConfig = (quality = exports.Quality.LOW, generator = 'local', model_url_resolver = (model_path) => Promise.resolve(toAbsoluteURI(model_path, BASE_URL)), base_url = BASE_URL, useLocalWorker = false) => {
...
const getConfig = (height, width, quality = exports.Quality.LOW, generator = 'local', renderConfig = {
    type: 'blur',
...
const defaultOptions = Object.freeze({
    ...
    blurStrength: exports.BlurStrength.STRONG,
    generator: 'worker',
    quality: exports.Quality.LOW,
    authToken: '',
    mirror: false,
});
...
VirtualBackgroundEffect.BlurStrength = exports.BlurStrength;
VirtualBackgroundEffect.Quality = exports.Quality;
