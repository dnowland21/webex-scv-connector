export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        resetOkInTransaction: 'done.invoke.roap.settingRemoteOffer:invocation[0]';
        ...
        sendRetryStateError: 'REMOTE_OFFER_ARRIVED' | 'REMOTE_OFFER_REQUEST_ARRIVED';
        sendRoapAnswerMessage: 'done.invoke.roap.settingRemoteOffer:invocation[0]';
        sendRoapOKMessage: 'REMOTE_ANSWER_ARRIVED' | 'done.invoke.roap.settingRemoteAnswer:invocation[0]';
        ...
        updateIsOkInTransaction: 'REMOTE_ANSWER_ARRIVED';
