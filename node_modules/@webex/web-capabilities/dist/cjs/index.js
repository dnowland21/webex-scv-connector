...
})(exports.BrowserName || (exports.BrowserName = {}));
...
class BrowserInfo {
    ...
    static isChrome() {
        return this.browser.getBrowserName() === exports.BrowserName.CHROME;
    }
    static isFirefox() {
        return this.browser.getBrowserName() === exports.BrowserName.FIREFOX;
    }
    static isEdge() {
        return this.browser.getBrowserName() === exports.BrowserName.EDGE;
    }
    static isSafari() {
        return this.browser.getBrowserName() === exports.BrowserName.SAFARI;
    }
    static isWindows() {
        return this.browser.getOSName() === exports.OSName.WINDOWS;
    }
    static isMac() {
        return this.browser.getOSName() === exports.OSName.MAC;
    }
    static isLinux() {
        return this.browser.getOSName() === exports.OSName.LINUX;
    }
...
class WebCapabilities {
    static isCapableOfBackgroundNoiseRemoval() {
        ...
        if (numCores === undefined) {
            return exports.CapabilityState.UNKNOWN;
        }
        if (numCores < 2) {
            return exports.CapabilityState.NOT_CAPABLE;
        }
        return exports.CapabilityState.CAPABLE;
    }
...
exports.WebCapabilities = WebCapabilities;
